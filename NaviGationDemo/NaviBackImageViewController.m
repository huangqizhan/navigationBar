...
@interface NaviBackImageViewController ()

@end

@implementation NaviBackImageViewController
...
- (void)viewDidLoad {
    ...
    [self h_setNavBarBackgroundImage:[UIImage imageNamed:@"navbg"]];  // millcolorGrad
